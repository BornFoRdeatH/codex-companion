...
Public Codex plugin marketplace containing **Codex Companion 0.6.1** (technical plugin ID `codex-usage-monitor`), with session-isolated local telemetry, Native History Focus, Usage Advisor, Usage Guard, and
