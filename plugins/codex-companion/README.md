...
The 1.3 Extension Platform renderer controls are available but disabled by default in 1.4.6.
...
Version 1.4.6 keeps public config `schema_version = 1`, uses internal SQLite schema v6, and adds
...
Version 1.4.6 resets the local feature-toggle namespace again so all previously enabled widgets
