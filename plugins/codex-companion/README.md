...
The 1.3 Extension Platform renderer controls are available but disabled by default in 1.3.9.
...
Version 1.3.9 keeps public config `schema_version = 1`, uses internal SQLite schema v6, and adds
...
Version 1.3.9 restores the Extension Platform runtime with widgets and extension controls disabled
